...
import { filters, singlefilters } from './Filter';

import { useNavigate, useLocation } from 'react-router-dom';  // Importing useLocation and useNavigate correctly
...
export default function Product() {
  ...
  const handleFilter = (value, sectionId) => {
    ...
    // Convert updated searchParams back to string and navigate
                  ...
                  <Disclosure key={section.id} as="div" className="border-b border-gray-200 py-6">
                    ...
                    <h3 className="-my-3 flow-root">
                      <DisclosureButton className="group flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                        ...
                        <FormLabel sx={{color:'black'}}  id="demo-radio-buttons-group-label text-gray-900">{section.name}</FormLabel>
                        <span className="ml-6 flex items-center">
                          <PlusIcon aria-hidden="true" className="h-5 w-5 group-data-[open]:hidden" />
                          <MinusIcon aria-hidden="true" className="h-5 w-5 [.group:not([data-open])_&]:hidden" />
                        </span>
